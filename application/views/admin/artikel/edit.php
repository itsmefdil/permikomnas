          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama" placeholder="Masukan Judul" value="<?php echo $artikel['judul']?>" name="judul">
                
              </div>
              <div class="form-group">
                <label for="nama">Penulis</label>
                <input type="text" class="form-control" id="nama" value="<?php echo $artikel['penulis']?>" name="penulis">
              </div>

              <div class="mb-3">
                <label>Konten</label>
                <textarea name="konten" class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $artikel['konten']?></textarea>
              </div>
            </div>
            <!-- /.card-body -->
          </div>
        ...
        <!-- /.card-body -->  <div class="col-md-4">
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <select class="custom-select" name="kategori">
                  <option value="<?php echo $artikel['kategori']?>" selected><b><?php echo $artikel['kategori']?> (Saat Ini)</b></option>
            ...
            <div class="form-group">
              ...
              <div class="imgWrap">
                <center><img  src="<?php echo base_url()?>uploads/images/<?php echo $artikel['foto']?>" id="imgView" class="img img-thumbnail"  width="70%"><br><br></center>
              </div>
