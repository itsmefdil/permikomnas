              ...
              <?php echo form_open_multipart('');?>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama" placeholder="Masukan Nama Lengkap" value="<?php echo $pengurus['nama']?>" name="nama">
                    <input type="hidden" class="form-control" id="nama" placeholder="Masukan Nama Lengkap" value="<?php echo $pengurus['foto']?>" name="foto-lama">
                  </div>
                    <div class="form-group">
                        <label for="jabatan">Pengurus</label>
                        <select class="custom-select" name="pengurus">
                          <option value="<?php echo $pengurus['pengurus']?>" selected><?php echo $pengurus['pengurus']?> (Saat Ini)</option>
                  ...
                  <div class="form-group">
                        ...
                        <select class="custom-select" name="jabatan">
                          <option value="<?php echo $pengurus['jabatan']?>" selected><?php echo $pengurus['jabatan']?> (Saat Ini)</option>
                  ...
                  <div class="form-group">
                        ...
                        <select class="custom-select" name="kampus">
                          <option value="<?php echo $pengurus['kampus']?>" selected><?php echo $pengurus['kampus']?> (Saat Ini)</option>
                ...
                <div class="card-footer">
                  <input type="submit" name="simpan" value="SIMPAN" class="btn btn-primary"> <a href="<?php echo base_url()?>admin/pengurus" class="btn btn-secondary"> Kembali</a>
                </div>
              </form>
            </div>
